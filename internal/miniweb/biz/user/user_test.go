...
import (
	...
	"github.com/bugsmo/miniweb/internal/pkg/model"
...
func Test_userBiz_ChangePassword(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:   args{context.Background(), "belm", &v1.ChangePasswordRequest{"miniweb1234", "miniweb12345"}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_userBiz_Login(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name:   "default",
			fields: fields{mockStore},
			args:   args{context.Background(), &v1.LoginRequest{Username: "belm", Password: "miniweb1234"}},
