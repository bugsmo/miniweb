...
// Source: github.com/bugsmo/miniweb/internal/miniweb/store (interfaces: IStore,UserStore,PostStore)
...
// Ldap mocks base method.
func (m *MockIStore) Ldap() *v3.Conn {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Ldap")
	ret0, _ := ret[0].(*v3.Conn)
	return ret0
}

// Ldap indicates an expected call of Ldap.
func (mr *MockIStoreMockRecorder) Ldap() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ldap", reflect.TypeOf((*MockIStore)(nil).Ldap))
}
