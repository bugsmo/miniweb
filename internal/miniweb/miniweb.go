...
import (
	...
	"github.com/bugsmo/miniweb/pkg/token"
	"github.com/bugsmo/miniweb/pkg/version/verflag"
)
...
Find more miniweb information at:
	https://github.com/bugsmo/miniweb#readme`,
...
func startGRPCServer() *grpc.Server {
	...
	pb.RegisterMiniWebServer(grpcsrv, user.New(store.S, nil))
